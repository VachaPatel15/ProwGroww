...
//     <div
//       id="navbar"
//       className={`bg-primary-light px-4 py-4 flex justify-between items-center shadow-md fixed top-0 w-full z-40`}
//     >
//       <div className="flex">
//         <div
//           className="flex justify-center items-center cursor-pointer ease-linear transition-all duration-500 hover:scale-110 hover:transition-all hover:duration-500 hover:ease-linear mr-4"
//           onClick={() => navigate("/")}
//         >
//           <svg
//             width="45"
...
//           <Link
//             to="/"
//             className="mx-3 font-medium px-2 py-2 uppercase text-sm tracking-wider cursor-pointer flex justify-center items-center flex-col relative"
//           >
//             <span
//               className={`z-20 transition-all duration-200 ease-linear ${
//                 props.menu === "/" && "font-bold text-dark-green"
//               } ${
//                 props.menu !== "/" && "text-dark-green font-semibold"
//               } hover:transition-all hover:ease-linear hover:duration-200`}
//             >
//               Home
//             </span>
//             {props.menu === "/" && (
//               <span className="rounded-full p-1 absolute z-10">
//                 <svg
//                   fill="#29AB8780"
//                   width="45px"
//                   height="45px"
...
//           </Link>
//           <div
//             className="mx-3 font-medium px-2 py-2 text-sm tracking-wider cursor-pointer flex justify-center items-center flex-col relative"
//             onMouseEnter={() => setMenu(true)}
//             onClick={() => setMenu(!menu)}
//           >
//             {menu && (
//               <ul
//                 className="absolute w-[280px] -bottom-[120px] left-0 bg-light-green shadow-md py-2 px-4 rounded-lg"
//                 onMouseLeave={() => setMenu(false)}
//               >
//                 <li
//                   className={`text-sm my-1 py-1 flex justify-start item cursor-pointer ${
//                     props.menu !== "/crop-recommend" &&
//                     "hover:text-secondary-light"
//                   } ease-linear transition-all duration-100 hover:transition-all hover:duration-100 hover:ease-linear ${
//                     props.menu === "/crop-recommend" &&
//                     "text-secondary-light font-semibold"
//                   }`}
...
//                 <li
//                   className={`text-sm my-1 py-1 flex justify-start item cursor-pointer ${
//                     props.menu !== "/fertilizer" && "hover:text-secondary-light"
//                   } ease-linear transition-all duration-100 hover:transition-all hover:duration-100 hover:ease-linear ${
//                     props.menu === "/fertilizer" &&
//                     "text-secondary-light font-semibold"
//                   }`}
...
//             )}
//             <span
//               className={`z-20 transition-all uppercase duration-200 ease-linear ${
//                 props.menu === "/services" && "font-bold text-dark-green"
//               } ${
//                 props.menu !== "/services" && "text-dark-green font-semibold"
//               } hover:transition-all hover:ease-linear hover:duration-200`}
//             >
//               Services
//             </span>
...
//             <span
//               className={`z-20 transition-all duration-200 ease-linear ${
//                 props.menu === "/query" && "font-bold text-dark-green"
//               } ${
//                 props.menu !== "/query" && "text-dark-green font-semibold"
//               } hover:transition-all hover:ease-linear hover:duration-200`}
//             >
//               Query
//             </span>
...
const Navbar = (props) => {
  ...
  const [menu, setMenu] = useState(false);
  useEffect(() => {
    document.title = "Home - Farm Insights";
      ...
      <div className="flex">
        ...
        <ul className="flex justify-between items-center">
          ...
          >
            <span
              className={`z-20 transition-all duration-200 ease-linear ${
                props.menu === "/crop-recommend" && "font-bold text-dark-green"
              } ${
                props.menu !== "/crop-recommend" &&
          ...
          >
            <span
              className={`z-20 transition-all duration-200 ease-linear ${
                props.menu === "/crop-disease" && "font-bold text-dark-green"
              } ${
                props.menu !== "/crop-disease" &&
                "text-dark-green font-semibold"
              } hover:transition-all hover:ease-linear hover:duration-200`}
          ...
          >
            <span
              className={`z-20 transition-all duration-200 ease-linear ${
                props.menu === "/fertilizer" && "font-bold text-dark-green"
              } ${
                props.menu !== "/fertilizer" && "text-dark-green font-semibold"
              } hover:transition-all hover:ease-linear hover:duration-200`}
            >
              Fertilizer Predictor 
            </span>
